...
export const FOOTBALL_METRICS: MetricDef[] = [
  {
    ...
    base: 5.6,
    spread: 3.4,
    aliases: ["escanteio", "escanteios", "corner", "corners"],
  },
  {
    key: "goals",
    label: "Gols marcados",
    unit: "gols por partida",
    base: 1.8,
    spread: 1.6,
    aliases: ["gol", "gols", "goals"],
  },
  {
    key: "goals_conceded",
    label: "Gols sofridos",
    unit: "gols sofridos por partida",
    base: 1.1,
    spread: 1.3,
    aliases: ["gols sofridos", "sofridos"],
  },
  {
    key: "shots",
    label: "Finalizações",
    unit: "finalizações por partida",
    base: 13.4,
    spread: 5.5,
    aliases: ["finalizacao", "finalizações", "finalizacoes", "chutes"],
  },
  {
    key: "shots_on_target",
    label: "Finalizações no alvo",
    unit: "finalizações no alvo por partida",
    base: 5.1,
    spread: 2.8,
    aliases: ["no alvo", "alvo", "shots on target"],
  },
  {
    key: "fouls_drawn",
    label: "Faltas recebidas",
    unit: "faltas recebidas por partida",
    base: 2.4,
    spread: 2.1,
    aliases: ["faltas recebidas", "falta recebida", "sofreu falta"],
  },
  {
    key: "cards",
    label: "Cartões",
    unit: "cartões por partida",
    base: 2.2,
    spread: 1.7,
    aliases: ["cartao", "cartões", "cartoes", "amarelo"],
  },
  {
    key: "assists",
    label: "Assistências",
    unit: "assistências por partida",
    base: 0.4,
    spread: 0.9,
    aliases: ["assistencia", "assistências", "assistencias"],
  },
  {
    key: "dribbles",
    label: "Dribles certos",
    unit: "dribles por partida",
    base: 3.1,
    spread: 2.4,
    aliases: ["drible", "dribles"],
  },
  {
    key: "key_passes",
    label: "Passes decisivos",
    unit: "passes decisivos por partida",
    base: 2.0,
    spread: 1.8,
    aliases: ["passe decisivo", "passes decisivos", "passes importantes"],
  },
  {
    key: "possession",
    label: "Posse de bola",
...
export const TENNIS_METRICS: MetricDef[] = [
  ...
  },
  {
    key: "double_faults",
    label: "Duplas faltas",
    unit: "duplas faltas por partida",
    base: 2.6,
    spread: 2.2,
    aliases: ["dupla falta", "duplas faltas"],
  },
  {
    key: "first_serve_pct",
    label: "1º serviço",
    ...
    base: 63,
    spread: 12,
    aliases: ["primeiro servico", "1o servico", "servico"],
  },
  {
    key: "winners",
    label: "Winners",
    unit: "winners por partida",
    base: 28,
    spread: 14,
    aliases: ["winner", "winners"],
  },
  {
    key: "break_points",
    label: "Break points convertidos",
    unit: "break points por partida",
    base: 3.2,
    spread: 2.6,
    aliases: ["break point", "break points", "quebras"],
  },
];
...
export const BASKETBALL_METRICS: MetricDef[] = [
  {
    ...
    base: 21.5,
    spread: 11,
    aliases: ["ponto", "pontos"],
  },
  {
    key: "rebounds",
    label: "Rebotes",
    unit: "rebotes por jogo",
    base: 6.8,
    spread: 4.5,
    aliases: ["rebote", "rebotes"],
  },
  {
    key: "three_points",
    label: "Bolas de 3",
    unit: "cestas de 3 por jogo",
    base: 2.6,
    spread: 2.4,
    aliases: ["tres pontos", "bola de 3", "3 pontos"],
  },
];
...
export function generateMatches(params: {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const raw =
      metric.base +
      (rand() - 0.45) * metric.spread +
      (venue === "home" ? metric.spread * 0.12 : -metric.spread * 0.08) +
      drift * metric.spread * 0.06;
    ...
    out.push({
      ...
      date: new Date(
        start - i * (1000 * 60 * 60 * 24 * (5 + Math.floor(rand() * 4))),
      ).toISOString(),
      ...
      outcome:
        sport === "tennis" ? (rand() > 0.35 ? "V" : "D") : gf > ga ? "V" : gf === ga ? "E" : "D",
      value,
...
export const FEATURED_ANALYSES: { title: string; question: string; tag: string }[] = [
  {
    title: "Média de aces de Alexander Zverev",
    question: "Quantos aces Alexander Zverev teve, em média, nos últimos 30 jogos?",
    tag: "Tênis · ATP",
  },
  {
    title: "Escanteios do Corinthians",
    question: "Qual foi a média de escanteios do Corinthians nos últimos 20 jogos?",
    tag: "Futebol · Brasileirão",
  },
  {
    title: "Faltas recebidas em La Liga",
    question: "Compare Nico Williams e Lamine Yamal em faltas recebidas nos últimos 10 jogos",
    tag: "Futebol · La Liga",
  },
  {
    title: "Flamengo fora de casa",
    question: "Mostre o desempenho do Flamengo em jogos fora de casa",
    tag: "Futebol · Brasileirão",
  },
  {
    title: "Finalizações no alvo na Premier League",
    question: "Média de finalizações no alvo de Mohamed Salah nos últimos 15 jogos",
    tag: "Futebol · Premier League",
  },
  {
...
export const FIXTURES: FixtureCard[] = [
  {
    ...
    awayId: "flamengo",
    competitionId: "brasileirao",
    kickoff: "2026-07-26T21:30:00.000Z",
    status: "finished",
    score: "2-1",
  },
  {
  ...
  },
  {
    ...
    competitionId: "premier",
    kickoff: "2026-07-29T16:00:00.000Z",
    status: "live",
    score: "0-0",
  },
  {
    ...
    awayId: "liverpool",
    competitionId: "ucl",
    kickoff: "2026-08-02T20:00:00.000Z",
    status: "scheduled",
  },
  {
    id: "f5",
    ...
    awayId: "barcelona",
    competitionId: "ucl",
    kickoff: "2026-08-05T22:00:00.000Z",
    status: "scheduled",
  },
  {
    id: "f6",
